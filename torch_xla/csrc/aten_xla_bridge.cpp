...
c10::optional<XLATensorPtr> TryGetXLATensor(const at::Tensor& tensor) {
...
at::Tensor XlaToAtenTensor(XLATensorPtr xla_tensor,
  ...
  // We need to copy the tensor since it is cached within the XLATensorPtr, and
